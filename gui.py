...
root=Tk()
root.title("Narucivanje hrane")

def kupac_dostavljac(username,password):
    pass
# def agencija():
...
password.pack()
login=Button(root,text='Login',command=lambda:kupac_dostavljac(username.get(),password.get()))
login.pack()
